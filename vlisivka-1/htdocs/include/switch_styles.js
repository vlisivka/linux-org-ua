...
window.onload = function(e) {
  var cookie = readCookie("loumain_textsize");
  var title = cookie ? cookie : getPreferredStyleSheetTxt();
  setActiveStyleSheetTxt(title);
  var cookie2 = readCookie("loumain_colscheme");
...
/*   createCookie("loumain_textsize", title, 365); */
/*   var title2 = getActiveStyleSheetCol(); */
/*   createCookie("loumain_colscheme", title2, 365); */
/* } */
